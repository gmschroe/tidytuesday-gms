...
<img src = 'plots/2023_wk25_ufos_US.png' width = 850 alt = 'Bubble chart of the number of UFO sightings, shown by point size, in the United States during each hour of each day in the calendar year. Polar coordinates are used to place the days of the year on a circle, creating a donut shape. Sightings are more frequent during the last few hours (during summer) or several hours (during winter) of the day, and sightings are especially common on Jan. 1 and July 4.'>

<img src = 'plots/2023_wk25_ufos_US_by_part.png?' width = 850 alt = 'Four bubble charts showing the number of UFO sightings in the United States during each hour of each day in the calendar year. Each chart shows sightings that occurred during a different time of day: dawn, day, dusk, or twilight. Sightings occur more frequently during twilight and the first part of the night.'>

Fewer UFO sightings were reported in the United Kingdom, but there are still some interesting trends:

<img src = 'plots/2023_wk25_ufos_GB.png' width = 850 alt = 'Bubble chart of the number of UFO sightings, shown by point size, in the United Kingdom during each hour of each day in the calendar year. Polar coordinates are used to place the days of the year on a circle, creating a donut shape. Sightings are more frequent during the last few hours (during summer) or several hours (during winter) of the day, and sightings are especially common in the first hour of Jan. 1.'>
